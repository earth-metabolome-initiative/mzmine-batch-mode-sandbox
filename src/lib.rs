...
pub mod modules{
    ...
    pub use crate::batchsteps::modular_adap_chromatogram_builder_module::ModularADAPChromatogramBuilderModuleParameter;

    pub use crate::batchsteps::smoothing_module::SmoothingModule;
    pub use crate::batchsteps::smoothing_module::SmoothingModuleParameters;
