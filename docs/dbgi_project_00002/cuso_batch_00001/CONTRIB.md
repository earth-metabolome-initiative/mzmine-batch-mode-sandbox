...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/mzmine-batch-mode-sandbox/docs/dbgi_project_00002/cuso_batch_00001/results
```
...
paths:
  ...
  input_folder: /Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/mzmine-batch-mode-sandbox/docs/dbgi_project_00002/cuso_batch_00001/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  project_name: cuso_batch_00001 #ISDB_annot_LP_plantfungi_set # The name you want to give to your project, output resulst in data_out/project_name
  output_folder: /Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/mzmine-batch-mode-sandbox/docs/dbgi_project_00002/cuso_batch_00001/results/met_annot_enhancer # the path for your output to be stored in
...
```yaml
paths:
  docs: '/Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/mzmine-batch-mode-sandbox/docs'
  output: '/Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/mzmine-batch-mode-sandbox/docs/dbgi_project_00002/cuso_batch_00001/results/stats' # Not mandatory, default is in the stats subdirectory
...
```yaml
mapp_project : dbgi_project_00002
mapp_batch : cuso_batch_00001
met_annot_enhancer_folder : cuso_batch_00001
gnps_job_id : 

dataset_experiment : 
  name: "cuso_batch_00001 LCMS metabolomics dataset"
  description: "Untargeted metabolomics of DBGI CUSO samples - test mzmine batch"
...
```bash
taxonomical-utils resolve-taxa --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata.tsv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata_resolved.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata_resolved.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_wd.csv
```

```bash
taxonomical-utils merge --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata.tsv --resolved-taxa-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata_resolved.csv --upper-taxa-lineage-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/metadata_upper_taxa_lineage.csv --wd-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_wd.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata.csv --org-column-header source_taxon
```
...
```bash
cd ./docs/dbgi_project_00002/cuso_batch_00001/
```
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_compound_summary.tsv --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer//nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/compound_identifications.tsv --isdb-file ./results/met_annot_enhancer/cuso_batch_00001/cuso_batch_00001_spectral_match_results_repond_flat.tsv --output ./results/tmp/cuso_batch_00001_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/cuso_batch_00001/cuso_batch_00001_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/compound_identifications.tsv  --output ./results/tmp/cuso_batch_00001_met_annot_unified_vertical.tsv
```